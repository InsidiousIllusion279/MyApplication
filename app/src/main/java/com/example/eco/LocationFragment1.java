...
public class LocationFragment1 extends Fragment {
    private static final int PERMISSION_ID = 1234;
    private String str = "Lol", status;
    private Retrofit retrofit;
    FusedLocationProviderClient mFusedLocationClient;
    com.example.eco.databinding.FragmentLocation1Binding binding;
    List<ImageInfo.Hit> hitList = new ArrayList<>();


    public LocationFragment1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.example.eco.databinding.FragmentLocation1Binding.inflate(inflater, container, false);
...
*/
                status = response.body().getWeather().get(0).getMain();
                 ...
                 intent.putExtra("key",status.toLowerCase());
